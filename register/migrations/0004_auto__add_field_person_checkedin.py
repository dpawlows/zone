...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.checkedin'
        db.add_column('register_person', 'checkedin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Person.checkedin'
        db.delete_column('register_person', 'checkedin')

    models = {
        'register.person': {
            'Meta': {'object_name': 'Person'},
            'abstract': ('django.db.models.fields.TextField', [], {'max_length': '20000', 'null': 'True', 'blank': 'True'}),
            'checkedin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
